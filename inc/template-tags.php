...
function businesspress_main_navigation() {
	...
	<nav class="main-navigation">
		<?php wp_nav_menu( array( 'theme_location' => 'primary', 'link_before'  => '<span class="screen-reader-text2">', 'link_after'  => '</span>' ) ); ?>
	</nav><!-- .main-navigation -->
	<?php
}
endif;
...
function businesspress_footer() {
	...
	<div class="site-info">
		<div class="site-copyright">
			&copy; <?php echo date_i18n('Y') ?> Jiromaru All rights reserved.
		</div><!-- .site-copyright -->
	</div><!-- .site-info -->
	<?php
	}
