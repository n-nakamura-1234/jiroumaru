...
function theme_enqueue_styles()
{
	...
	// datepickerのカスタムスタイルを追加
	wp_add_inline_style('jquery-ui', '
...
function theme_enqueue_scripts()
{
	...
	if (is_page('contact')) {
		...
		wp_enqueue_script('contact-script', get_stylesheet_directory_uri() . '/js/contact.js', array('jquery', 'jquery-ui'), '1.0.4', true);
	}
	wp_localize_script('orignal-script', 'jiromaruData', array(
		'ajaxurl' => admin_url('admin-ajax.php'),
		'holidaysApiUrl' => 'https://holidays-jp.github.io/api/v1/date.json'
	));
}
